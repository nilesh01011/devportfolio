...
function AboutSections({ skills }) {
    return (
        <>
            <div id="about" className='h-full xl:px-0 px-[15px] sm:mt-[100px] mt-[50px]'>
                ...
                <div className='w-full flex items-center lg:flex-row flex-col justify-between gap-[30px]'>
                    ...
                    <div className='lg:w-[55%] w-full text-left lg:order-1 order-2'>
                        <div className="w-full text-left">
                            ...
                            <p className='mb-[1rem] mt-[0.5rem] font-bold xsxs:text-[1.7rem] text-[1.2rem]'>Developer ? <span className='text-[#01D9D2]'>Front </span>End : <span className='text-[#01D9D2]'>Back </span>End</p>
