...
function AboutSections({ skills }) {
    return (
        <motion.div variants={staggerContainer} initial="hidden" whileInView="show" id="about" className='h-full xl:px-0 px-[15px] sm:mt-[100px] mt-[50px]'>
            ...
            <div className='w-full flex items-center lg:flex-row flex-col justify-between gap-[30px]'>
                ...
                <div className='lg:w-[55%] lg:text-left text-center w-full lg:order-1 order-2'>
                    ...
                    {/* buttons */}
                    <motion.button variants={textVariant(0.9)} className='font-[500] my-10 w-max h-max'>
            ...
            {/* tabs views */}
            <motion.div variants={zoomIn(0.4, 1)} className='w-full h-max md:mt-[100px] mt-[60px]'>
