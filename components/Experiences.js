...
function Experiences() {
    ...
    return (
        <div id="experience" className='w-full h-full xl:px-0 px-[15px] dark:text-white text-black md:mb-[80px] mb-[40px] py-[3rem] relative overflow-hidden sm:mt-[100px] mt-[50px]'>
            {/* titles */}
