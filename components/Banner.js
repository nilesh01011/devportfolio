    ...
    return (
        <div id="banner" className='w-full min-h-screen flex items-center flex-col justify-center px-[15px] relative'>
            ...
            <div className='h-full flex items-center flex-col justify-center'>
                ...
                <div className='block text-center 1x1:my-[2rem] mt-[1rem] md:mb-[2rem] mb-[1.8rem] md:leading-[38px] xsxs:leading-[56px] leading-[48px] tracking-[1px] text-transparent bg-clip-text bg-gradient-to-r from-[#037ADE] to-[#03E5B7]'>
