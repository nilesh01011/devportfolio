...
function ProjectsWorks({ allProjects, tabs }) {
    ...
    return (
        <motion.div variants={staggerContainer} initial="hidden" whileInView="show" id="project" className='w-full h-full xl:px-0 px-[15px] dark:text-white text-black py-[3rem] sm:mt-[100px] mt-[50px]'>
            {/* titles */}
            ...
            {/* contents */}
            <motion.div variants={zoomIn(0.4, 1)} className='w-full h-auto'>
